...
function Footer() {
    return (
        <>
            ...
            <div id="footer" className='col-12 col-lg-12 col-md-12 d-flex justify-content-center align-item-center p-4'>
                <div>
                    ...
                    <div className='cursor-pointer'>
                        <Nav defaultActiveKey="/" as="ul">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/task" className='text-light'>Task</Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/calendar" className='text-light'>Calendar</Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li">
